...
<head>
  ...
  <style>
    ...
    .grid.grid-3x2 {
      ...
      grid-template-rows: repeat(2, 1fr) !important; /* 1행과 2행 비율 동일하게 꽉 채움 */
      gap: 20px !important;
    }
...
<body class="page threshold-page">
  ...
  <div class="content-area" id="contentArea">
    ...
    <div class="grid grid-3x2" id="grid">
      ...
      <section class="card compact">
        ...
        <div class="form one"><div class="row"><div class="label">상한(명)</div><div class="field"><input class="input" type="number" id="people_high" /><span class="unit">명</span></div></div></div>
      </section>
      ...
      <section class="card compact">
        ...
        <div class="form one"><div class="row"><div class="label">알림 기준</div><div class="field"><input class="input" type="number" id="towel_threshold" /><span class="unit">%</span></div></div></div>
      </section>
      ...
      <section class="card compact">
        ...
        <div class="form one"><div class="row"><div class="label">알림 기준</div><div class="field"><input class="input" type="number" id="soap_threshold" /><span class="unit">%</span></div></div></div>
      </section>
    </div>
  </div>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      // ✅ 헤더에서 버튼 요소를 찾아 시계 ID(#real-time-clock)로 교체
      const target = document.querySelector('.header button') || document.querySelector('[class*="btn"]') || document.querySelector('.header .status-btn');
      if (target) {
        target.id = 'real-time-clock';
        target.className = ''; // 기존 버튼 클래스 제거
